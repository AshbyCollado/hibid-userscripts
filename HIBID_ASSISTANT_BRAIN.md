...
### Cross-browser stale-install check (`v0.8.16`)
...
- Confirm the active userscript in each browser profile with all three signals: Tampermonkey script version `0.8.16`, `#flipperaddon-panel[data-flipperaddon-version="0.8.16"]`, and `window.__FLIPPERADDON_VERSION__ === '0.8.16'` when page access exposes the canary.
